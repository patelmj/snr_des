...
# Try to avoid changing this, the motor could overvolt and freak out
...
def main(ph, port_num, number_of_flaps):
...
if __name__ == '__main__':
    ...
    print(main(control[0], control[1], number_of_flaps))
